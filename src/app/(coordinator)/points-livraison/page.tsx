    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div className="md:hidden divide-y divide-gray-100">
          {points.map((point) => (
            <div key={point.id} className="p-4 space-y-2">
              <div className="flex items-start justify-between gap-2">
                <div className="min-w-0">
                  ...
                  <p className="text-xs text-gray-400">{point.commune}</p>
                </div>
                <span className={`shrink-0 inline-flex px-2 py-0.5 rounded-full text-xs font-medium ${point.isActive ? "bg-green-100 text-green-700" : "bg-gray-100 text-gray-500"}`}>
          ...
          {points.length === 0 && (
            <p className="px-4 py-8 text-center text-gray-400">Aucun point de livraison.</p>
          )}
        </div>
