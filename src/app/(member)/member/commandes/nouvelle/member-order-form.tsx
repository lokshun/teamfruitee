...
export function MemberOrderForm({
  ...
  const [paymentReferentId, setPaymentReferentId] = useState("")
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-5">
      ...
      <div className="space-y-3">
        <h2 className="text-base font-semibold text-gray-900">Produits disponibles</h2>
      ...
      <div>
        ...
        <textarea
          ...
          rows={2}
          className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-500"
          placeholder="Ex. : allergies, préférence de packaging…"
        />
      </div>
